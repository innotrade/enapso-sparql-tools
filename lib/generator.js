    ...
    evaluateRestrictionType(key) {
        ...
        if (key.some) {
            ...
            if (key.max.includes('#')) {
                ...
                propIRI = `owl:onDataRange ${key.max}`;
            }
            property = `${property}
            ${propIRI}`;
        } else if (key.min) {
